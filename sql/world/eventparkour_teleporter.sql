-- --------------------------------------------------------------------------------------
--	PARKOUR TELEPORTER - 190012
-- --------------------------------------------------------------------------------------
SET
@Entry 		:= 190012,
@Model 		:= 9353, -- Undead Necromancer
@Name 		:= "Teletransportador Frank",
...
INSERT INTO `npc_text` (`ID`, `text0_0`) VALUES (@Entry, 'Hola $N. Estoy a tu servicio.\r\nPuedo teletransportarte de regreso a las principales ciudades, de esta forma volveras a estar en la fase visible correcta.');
