...
enum BRMensaje
{
    BR_MENSAJE_ESTADO_OK = 0,
    BR_MENSAJE_ESTADO_EN_CURSO,
    BR_MENSAJE_ESTADO_LLENO,
    BR_MENSAJE_ERROR_MAZMORRA,
    BR_MENSAJE_ERROR_BG,
    BR_MENSAJE_ERROR_EN_COLA,
    BR_MENSAJE_ERROR_EN_EVENTO,
    BR_MENSAJE_ERROR_EN_VUELO,
    BR_MENSAJE_ERROR_BLOQUEADO,
    BR_MENSAJE_ERROR_DK_INICIO,
    BR_MENSAJE_ERROR_NIVEL,
};
